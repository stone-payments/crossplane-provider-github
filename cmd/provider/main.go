...
import (
	...
	github "github.com/crossplane-contrib/provider-github/pkg/controller"
)
...
func main() {
	...
	log.Debug("Starting", "sync", syncInterval.String())
	log.Debug("Starting", "pool", pollInterval.String())
